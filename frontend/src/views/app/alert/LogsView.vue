  ...
  <div>
    <div class="alert-summary">
      <div>
        ...
        <div class="alert-summary-desc">최근 7일간의 알림 기록만 표시됩니다. (최근 500건)</div>
      </div>

      <div class="alert-summary-count">{{ alertLogs.length }}건</div>
    </div>
    ...
    >
      ...
      <template #empty>
        <div class="alert-list-empty">더 이상 보관된 기록이 없습니다.</div>
      </template>
    </v-infinite-scroll>
  </div>
...
import { AlertEventStatusFilter } from '@/services/alert.types'
import { useAlertStore } from '@/stores/alert.store'

const logAction = useAsyncAction()
const alertStore = useAlertStore()
const { alertLogs, currentAlertListKey, currentAlertEventStatus, alertHasMore, alertLoadingMore } =
