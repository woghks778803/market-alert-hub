...
from app.api.router.public import router as public_router
from app.api.router.admin import public as admin_public_router, protected as admin_protected_router
