...
class UserOauthAccount(Base):
    ...
    oauth_providers_id: Mapped[int] = mapped_column(
        ForeignKey("oauth_providers.id"), nullable=False
    )
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "oauth_providers_id", "provider_user_id", name="uq_oauth_provider_uid"
        ),
    ...
    @classmethod
    def from_create_dto(cls, dto: UserDTO.UserOAuthAccountCreate) -> "UserOauthAccount":
        return cls(
            user_id=dto.user_id,
            oauth_providers_id=dto.oauth_providers_id,
            provider_user_id=dto.provider_user_id,
            linked_at=dto.linked_at,
        )
