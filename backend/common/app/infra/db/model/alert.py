...
class Alert(Base):
    ...
    status: Mapped[AlertStatus] = mapped_column(
        SAEnum(
            AlertStatus, native_enum=True, create_constraint=True, validate_strings=True
        ),
    ...
    scope: Mapped[AlertScope] = mapped_column(
        SAEnum(
            AlertScope, native_enum=True, create_constraint=True, validate_strings=True
        ),
    ...
    #     SAEnum(
    #         AlertType, native_enum=True, create_constraint=True, validate_strings=True
    #     ),
    #     default=AlertType.PRICE,
    #     server_default=AlertType.PRICE,
    #     nullable=False,
    # )
